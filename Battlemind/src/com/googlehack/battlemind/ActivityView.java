...
public class ActivityView extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.ActivityView, defStyle, 0);

		mExampleString = a.getString(R.styleable.ActivityView_exampleString);
		mExampleColor = a.getColor(R.styleable.ActivityView_exampleColor,
				mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(
				R.styleable.ActivityView_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.ActivityView_exampleDrawable)) {
			mExampleDrawable = a
					.getDrawable(R.styleable.ActivityView_exampleDrawable);
